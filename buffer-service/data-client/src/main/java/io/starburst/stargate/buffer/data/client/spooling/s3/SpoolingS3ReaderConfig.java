...
public class SpoolingS3ReaderConfig
{
    ...
    public SpoolingS3ReaderConfig setS3AwsAccessKey(String s3AwsAccessKey)
    {
    ...
    public SpoolingS3ReaderConfig setS3AwsSecretKey(String s3AwsSecretKey)
    {
    ...
    public SpoolingS3ReaderConfig setS3Endpoint(String s3Endpoint)
    {
    ...
    public SpoolingS3ReaderConfig setRetryMode(RetryMode retryMode)
    {
    ...
    public SpoolingS3ReaderConfig setMaxErrorRetries(int maxErrorRetries)
    {
