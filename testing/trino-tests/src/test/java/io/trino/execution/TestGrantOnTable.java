...
public class TestGrantOnTable
{
            ...
            throws Exception
    {
        ...
        tableGrants.grant(new TrinoPrincipal(USER, "admin"), view, TABLE_PRIVILEGES, true);
        tableGrants.grant(new TrinoPrincipal(USER, "admin"), materializedView, TABLE_PRIVILEGES, true);
    }
