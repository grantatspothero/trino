...
@TestsEnvironment
public final class EnvMultinodeWarpSpeed2
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvMultinodeWarpSpeed2(DockerFiles dockerFiles,
                                  ...
                                  Minio minio)
    {
        ...
        configDir = dockerFiles.getDockerFilesHostDirectory("conf/environment/multinode-warp-speed-2");
    }
