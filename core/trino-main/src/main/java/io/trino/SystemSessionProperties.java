        ...
        implements SystemSessionPropertiesProvider
{
    ...
    public static final String HISTORY_BASED_STATS_ENABLED = "history_based_stats_enabled";
            ...
            NodeSchedulerConfig nodeSchedulerConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        GATHER_PARTIAL_TOPN,
                        "Gather partial TopN using round robin and gather local exchanges",
                        optimizerConfig.isGatherPartialTopN(),
                        true),
                booleanProperty(
                        // Useful to make EXPLAIN or SHOW STATS provide stats for a query involving TopN
                ...
                booleanProperty(
                        ...
                        true),
                booleanProperty(
                        FAULT_TOLERANT_EXECUTION_STAGE_ESTIMATION_BY_STATS_ENABLED,
    ...
    public static boolean isGatherPartialTopN(Session session)
    {
        return session.getSystemProperty(GATHER_PARTIAL_TOPN, Boolean.class);
    }
    ...
    public static boolean isHistoryBasedStatsEnabled(Session session)
    {
        return session.getSystemProperty(HISTORY_BASED_STATS_ENABLED, Boolean.class);
    }
