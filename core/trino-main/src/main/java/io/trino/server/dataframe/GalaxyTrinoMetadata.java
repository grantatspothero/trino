...
public class GalaxyTrinoMetadata
        implements TrinoMetadata
{
    private static final Logger log = Logger.get(GalaxyTrinoMetadata.class);
    private final Session session;
    private final AnalyzerFactory analyzerFactory;
    private final SqlParser sqlParser;
    private final DataTypeMapper dataTypeMapper;

    public GalaxyTrinoMetadata(Session session, AnalyzerFactory analyzerFactory, SqlParser sqlParser, DataTypeMapper dataTypeMapper)
    {
