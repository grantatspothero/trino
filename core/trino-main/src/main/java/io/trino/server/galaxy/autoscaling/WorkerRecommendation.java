 ...
 */
public record WorkerRecommendation(int recommendedComputeUnits, Map<String, String> debugMetrics)
{
    public WorkerRecommendation
    {
        debugMetrics = ImmutableMap.copyOf(requireNonNull(debugMetrics, "debugMetrics is null"));
    }
}
