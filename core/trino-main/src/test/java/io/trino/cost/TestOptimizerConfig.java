...
public class TestOptimizerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(OptimizerConfig.class)
                ...
                .setJoinPushdownAcrossCatalogsEnabled(false)
                ...
                .setHistoryBasedStatisticsEnabled(false)
                ...
                .setUseHighestCardinalityColumnForForcedExchangeBelowGroupId(true)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("optimizer.history-based-statistics.enabled", "true")
                ...
                .put("optimizer.join-pushdown-across-catalogs-enabled", "true")
                ...
                .put("use-highest-cardinality-column-for-forced-exchange-below-group-id", "false")
                .put("colocated-joins-enabled", "false")
                .put("spatial-joins-enabled", "false")
                .put("distributed-sort", "false")
                .put("gather-partial-topn", "false")
        ...
        OptimizerConfig expected = new OptimizerConfig()
                ...
                .setHistoryBasedStatisticsEnabled(true)
                ...
                .setJoinPushdownAcrossCatalogsEnabled(true)
                ...
                .setUseHighestCardinalityColumnForForcedExchangeBelowGroupId(false)
