...
public class TestColumnMask
{
    ...
    public void testColumnMaskFunctions()
    {
        ...
        ViewExpression viewExpression = ViewExpression.builder()
                .identity(USER)
                .expression("\"$sb_internal_mask_varchar_all_but_last_four\"(cast(\"@column\" as varchar))")
                .build();
        accessControl.columnMask(
                new QualifiedObjectName(LOCAL_CATALOG, "tiny", "orders"),
                "comment",
    ...
    public void testColumnMaskWithStringLongerThanResultType()
    {
        ...
        ViewExpression viewExpression = ViewExpression.builder()
                .identity(USER)
                .expression("'A very long string that will get truncated because the comment column has type varchar(79)'")
                .build();
        accessControl.columnMask(
                new QualifiedObjectName(LOCAL_CATALOG, "tiny", "orders"),
                "comment",
