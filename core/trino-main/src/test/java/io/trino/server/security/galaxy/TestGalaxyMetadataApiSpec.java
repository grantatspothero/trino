                ...
                for (boolean grantOption : TRUE_AND_FALSE) {
                    ...
                    withGrantedPrivilege(adminRoleId, catalogId, CREATE_SCHEMA, ALLOW, roleName, grantOption, () ->
                            assertThat(client.getEntityPrivileges(dispatchSession(roleId), catalogId))
                                    .isEqualTo(new EntityPrivileges(ACCOUNT_ADMIN_ROLE, adminRoleId, true, false, ImmutableSet.of(new GalaxyPrivilegeInfo(CREATE_SCHEMA, grantOption)), ImmutableMap.of(), ImmutableList.of(), ImmutableMap.of())));
                    ...
                    withGrantedPrivilege(adminRoleId, schemaId, CREATE_TABLE, ALLOW, roleName, grantOption, () ->
                            assertThat(client.getEntityPrivileges(dispatchSession(roleId), schemaId))
                                    .isEqualTo(new EntityPrivileges(ACCOUNT_ADMIN_ROLE, adminRoleId, false, false, ImmutableSet.of(new GalaxyPrivilegeInfo(CREATE_TABLE, grantOption)), ImmutableMap.of(), ImmutableList.of(), ImmutableMap.of())));
