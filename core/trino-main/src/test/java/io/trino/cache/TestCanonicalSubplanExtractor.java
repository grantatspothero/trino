        ...
        extends BasePlanTest
{
    ...
    private static final SymbolReference REGIONKEY_REF = new SymbolReference(BIGINT, "[regionkey:bigint]");
    private static final SymbolReference NATIONKEY_REF = new SymbolReference(BIGINT, "[nationkey:bigint]");
    private static final SymbolReference NAME_REF = new SymbolReference(createVarcharType(25), "[name:varchar(25)]");
    ...
    public void testAggregationWithMultipleGroupByColumnsAndPredicate()
    {
        ...
        Expression nonPullableConjunct = new ComparisonExpression(GREATER_THAN, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 10L));
        Expression pullableConjunct = new ComparisonExpression(EQUAL, new SymbolReference(createVarcharType(25), "[name:varchar(25)]"), new Constant(createVarcharType(25), utf8Slice("0123456789012345689012345")));
        ...
        CacheColumnId regionKeyGreaterThan10 = canonicalExpressionToColumnId(new ComparisonExpression(GREATER_THAN, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 10L)));
        CacheColumnId regionKeyMultiplyBy2 = canonicalExpressionToColumnId(new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 2L)));
        assertThat(nonAggregatedSubplan.getAssignments()).containsExactly(
                entry(NATIONKEY_ID, NATIONKEY_REF),
                entry(NAME_ID, NAME_REF),
                entry(regionKeyGreaterThan10, new ComparisonExpression(GREATER_THAN, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 10L))),
                entry(regionKeyMultiplyBy2, new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 2L))));
        ...
        Expression filteredSum = new CanonicalAggregation(
                ...
                List.of(new SymbolReference(BIGINT, "[nationkey:bigint]")));
        ...
        assertThat(getGroupByExpressions(aggregatedSubplan)).contains(ImmutableList.of(
                new SymbolReference(createVarcharType(25), "[name:varchar(25)]"),
        ...
        assertThat(aggregatedSubplan.getOriginalSymbolMapping()).containsOnlyKeys(
                ...
                NAME_ID,
                REGIONKEY_ID,
                canonicalExpressionToColumnId(new ComparisonExpression(GREATER_THAN, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 10L))),
                canonicalExpressionToColumnId(new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 2L))),
        ...
        assertThat(aggregatedSubplan.getAssignments()).containsExactly(
                entry(NAME_ID, new SymbolReference(createVarcharType(25), "[name:varchar(25)]")),
                entry(canonicalExpressionToColumnId(new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 2L))), columnIdToSymbol(regionKeyMultiplyBy2).toSymbolReference()),
    ...
    public void testAggregationWithMultipleGroupByColumns()
    {
        ...
        assertThat(nonAggregatedSubplan.getAssignments()).containsExactly(
                ...
                entry(nationKeyPlusOne, new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 1L))));
        assertThat(nonAggregatedSubplan.getTableScan()).isPresent();
        assertThat(nonAggregatedSubplan.getChildSubplan()).isEmpty();
        assertThat(nonAggregatedSubplan.getTableScan().get().getColumnHandles()).containsExactly(
                entry(NATIONKEY_ID, new TpchColumnHandle("nationkey", BIGINT)),
        ...
        assertThat(aggregatedSubplan.getOriginalSymbolMapping()).containsOnlyKeys(
                ...
                NAME_ID,
                REGIONKEY_ID,
                canonicalExpressionToColumnId(new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 1L))),
                canonicalExpressionToColumnId(sum));
        assertThat(aggregatedSubplan.getAssignments()).containsExactly(
                entry(NAME_ID, new SymbolReference(createVarcharType(25), "[name:varchar(25)]")),
                entry(REGIONKEY_ID, new SymbolReference(BIGINT, "[regionkey:bigint]")),
                entry(canonicalExpressionToColumnId(sum), sum));
        assertThat(aggregatedSubplan.getConjuncts()).isEmpty();
    ...
    public void testNestedProjections()
    {
        ...
        Expression nationKeyMultiplyBy2 = new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "[nationkey:bigint]"), new Constant(BIGINT, 2L));
        Expression regionKeyPredicate = new ComparisonExpression(GREATER_THAN, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 10L));
        CacheTableId tableId = new CacheTableId(tpchCatalogId + ":tiny:nation:0.01");
    ...
    public void testBigintAggregation()
    {
        ...
        CanonicalSubplan aggregatedSubplan = subplans.get(1);
        assertThat(aggregatedSubplan.getOriginalPlanNode()).isInstanceOf(AggregationNode.class);
        assertThat(getGroupByExpressions(aggregatedSubplan)).contains(ImmutableList.of(new SymbolReference(BIGINT, "[regionkey:bigint]")));
        assertThat(aggregatedSubplan.getOriginalSymbolMapping()).containsOnlyKeys(
                NATIONKEY_ID,
                REGIONKEY_ID,
                canonicalExpressionToColumnId(sum));
    ...
    public void testTopNWithExpressionInOrderByColumn()
    {
        ...
        CanonicalSubplan scanSubplan = subplans.get(0);
        CacheColumnId regionKeyAdded5 = canonicalExpressionToColumnId(new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 5L)));
        assertThat(scanSubplan.getAssignments()).containsExactly(
                entry(NATIONKEY_ID, NATIONKEY_REF),
                entry(regionKeyAdded5, new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[regionkey:bigint]"), new Constant(BIGINT, 5L))));
        CanonicalSubplan topNSubplan = subplans.get(1);
        assertThat(topNSubplan.getKey()).isInstanceOf(TopNKey.class);
        TopNKey key = (TopNKey) topNSubplan.getKey();
    ...
    public void testExtractCanonicalScanAndProject()
    {
        ...
        assertThat(subplan.getOriginalSymbolMapping()).containsExactly(
                entry(new CacheColumnId("[cache_column1]"), new Symbol(BIGINT, "symbol1")),
                entry(new CacheColumnId("[cache_column2]"), new Symbol(BIGINT, "symbol2")),
                entry(canonicalExpressionToColumnId(new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[cache_column1]"), new Constant(BIGINT, 1L))), new Symbol(BIGINT, "projection1")));
        assertThat(subplan.getAssignments()).containsExactly(
                entry(canonicalExpressionToColumnId(new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[cache_column1]"), new Constant(BIGINT, 1L))), new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[cache_column1]"), new Constant(BIGINT, 1L))),
                entry(new CacheColumnId("[cache_column2]"), new SymbolReference(BIGINT, "[cache_column2]")));
    ...
    public void testExtractCanonicalFilterAndProject()
    {
        ...
        assertThat(predicate).isEqualTo(new ComparisonExpression(GREATER_THAN, new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "[cache_column1]"), new SymbolReference(BIGINT, "[cache_column2]")), new Constant(BIGINT, 0L)));
        ...
        assertThat(DynamicFilters.getDescriptor(dynamicFilterExpression)).contains(
                new DynamicFilters.Descriptor(new DynamicFilterId("dynamic_filter_id"), new SymbolReference(BIGINT, "[cache_column1]")));
    ...
    public void testExtractCanonicalFilter()
    {
        ...
        assertThat(subplan.getOriginalSymbolMapping()).containsExactly(
                ...
                entry(new CacheColumnId("[cache_column2]"), new Symbol(BIGINT, "symbol2")));
        assertThat(subplan.getAssignments()).containsExactly(
                entry(new CacheColumnId("[cache_column1]"), new SymbolReference(BIGINT, "[cache_column1]")),
                entry(new CacheColumnId("[cache_column2]"), new SymbolReference(BIGINT, "[cache_column2]")));
    ...
    public void testProjectionWithDuplicatedExpressions()
    {
        assertThatCanonicalSubplanIsForTableScan(new ProjectNode(
                ...
                Assignments.of(
                        ...
                        new ArithmeticBinaryExpression(MULTIPLY_BIGINT, MULTIPLY, new SymbolReference(BIGINT, "symbol1"), new Constant(BIGINT, 2L)),
    ...
    public void testAliasingProjection()
    {
        assertThatCanonicalSubplanIsForTableScan(new ProjectNode(
                ...
                Assignments.of(
                        ...
                        new SymbolReference(BIGINT, "symbol1"))));
        assertThatCanonicalSubplanIsForTableScan(new ProjectNode(
                new PlanNodeId("project_node"),
                createTableScan(),
                Assignments.of(
    ...
    private ProjectNode createScanAndProjectNode()
    {
        return new ProjectNode(
                ...
                Assignments.of(
                        ...
                        new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "symbol1"), new Constant(BIGINT, 1L)),
                        new Symbol(BIGINT, "symbol2"),
                        new SymbolReference(BIGINT, "symbol2")));
    }
    ...
    private FilterNode createFilterNode()
    {
        ...
        return new FilterNode(
                ...
                createTableScan(),
                and(
                        new ComparisonExpression(GREATER_THAN, new ArithmeticBinaryExpression(ADD_BIGINT, ADD, new SymbolReference(BIGINT, "symbol1"), new SymbolReference(BIGINT, "symbol2")), new Constant(BIGINT, 0L)),
