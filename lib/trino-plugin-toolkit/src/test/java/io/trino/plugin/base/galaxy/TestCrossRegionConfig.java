...
public class TestCrossRegionConfig
{
    @Test
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(CrossRegionConfig.class)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                .put("galaxy.cross-region.allow-cross-region-access", "true")
                .put("galaxy.cross-region.read-limit", "500TB")
                .put("galaxy.cross-region.write-limit", "250MB")
                .buildOrThrow();

        CrossRegionConfig expected = new CrossRegionConfig()
