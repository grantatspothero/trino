...
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_MAX_CONNECTIONS;
...
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_MULTIPART_MIN_FILE_SIZE;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_MULTIPART_MIN_PART_SIZE;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_NON_PROXY_HOSTS;
...
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PREEMPTIVE_BASIC_PROXY_AUTH;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PROXY_HOST;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PROXY_PASSWORD;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PROXY_PORT;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PROXY_PROTOCOL;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_PROXY_USERNAME;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_REGION;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_REQUESTER_PAYS_ENABLED;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_SECRET_KEY;
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_SIGNER_CLASS;
...
import static io.trino.hdfs.s3.TrinoS3FileSystem.S3_STORAGE_CLASS;
