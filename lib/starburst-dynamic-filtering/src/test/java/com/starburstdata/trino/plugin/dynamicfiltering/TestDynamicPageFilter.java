...
import static com.starburstdata.trino.plugin.dynamicfiltering.DictionaryAwarePageFilter.BlockFilterStats;
import static com.starburstdata.trino.plugin.dynamicfiltering.DictionaryAwarePageFilter.SelectedPositionsWithStats;
import static com.starburstdata.trino.plugin.dynamicfiltering.SelectedPositions.positionsList;
import static com.starburstdata.trino.plugin.dynamicfiltering.SelectedPositions.positionsRange;
...
public class TestDynamicPageFilter
{
    ...
    public void testDictionaryBlockWithNulls()
    {
        ...
        blockFiltersOptional = createBlockFilters(
                ...
                ImmutableMap.of(column, 0));
        assertThat(blockFiltersOptional).isPresent();
        blockFilters = blockFiltersOptional.get().toArray(new DynamicPageFilter.BlockFilter[0]);
        assertThat(
                filter.filterPage(new Page(dictionaryBlock), blockFilters, blockFilters.length).getPositions())
