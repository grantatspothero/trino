        ...
        try {
            if (compressedPage instanceof DataPageV1 dataPageV1) {
                return new DataPageV1(
                        decompress(codec, dataPageV1.getSlice(), dataPageV1.getUncompressedSize(), isNativeZstdDecompressorEnabled),
            ...
            return new DataPageV2(
                    ...
                    decompress(codec, dataPageV2.getSlice(), uncompressedSize, isNativeZstdDecompressorEnabled),
    ...
    public DictionaryPage readDictionaryPage()
    {
        ...
        try {
            ...
            return new DictionaryPage(
                    decompress(codec, compressedDictionaryPage.getSlice(), compressedDictionaryPage.getUncompressedSize(), isNativeZstdDecompressorEnabled),
