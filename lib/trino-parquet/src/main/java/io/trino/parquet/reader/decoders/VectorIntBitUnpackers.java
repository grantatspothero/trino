...
public final class VectorIntBitUnpackers
{
            ...
            implements IntBitUnpacker
    {
        ...
        private static void unpack8(int[] output, int outputOffset, byte[] input, int inputOffset)
        {
            ...
            ByteVector tempRes1 = byteVector.rearrange(SHUFFLE_BEFORE_LSHR)
                    .lanewise(VectorOperators.LSHR, LSHR_BYTE_VECTOR)
                    .and(MASK_3);

            ByteVector tempRes2 = byteVector.rearrange(SHUFFLE_BEFORE_LSHL)
                    .and(MASK_BEFORE_LSHL)
                    .lanewise(VectorOperators.LSHL, LSHL_BYTE_VECTOR);

            tempRes1.or(tempRes2)
                    .castShape(IntVector.SPECIES_256, 0)
                    .reinterpretAsInts()
                    .intoArray(output, outputOffset);
        }
            ...
            implements IntBitUnpacker
    {
        ...
        private static void unpack8(int[] output, int outputOffset, byte[] input, int inputOffset)
        {
            ...
            ShortVector tempRes1 = shortVector.rearrange(SHUFFLE_BEFORE_LSHR)
                    .lanewise(VectorOperators.LSHR, LSHR_SHORT_VECTOR)
                    .and(MASK_6);

            ShortVector tempRes2 = shortVector.rearrange(SHUFFLE_BEFORE_LSHL)
                    .and(MASK_BEFORE_LSHL)
            ...
            implements IntBitUnpacker
    {
        ...
        private static void unpack8(int[] output, int outputOffset, byte[] input, int inputOffset)
        {
            ...
            IntVector tempRes1 = intVector.rearrange(SHUFFLE_BEFORE_LSHR)
                    .lanewise(VectorOperators.LSHR, LSHR_INT_VECTOR)
                    .and(MASK_17);

            IntVector tempRes2 = intVector.rearrange(SHUFFLE_BEFORE_LSHL)
                    .and(MASK_BEFORE_LSHL)
