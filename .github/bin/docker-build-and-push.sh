...
`# temporary tags until we remove appending -jdk21 in stargate` \
  --tag "179619298502.dkr.ecr.us-east-1.amazonaws.com/${IMAGE_NAME}-jdk21" \
  --tag "us-east1-docker.pkg.dev/starburstdata-saas-prod/starburst-docker-repository/${IMAGE_NAME}-jdk21" \
  --tag "starburstgalaxy.azurecr.io/${IMAGE_NAME}-jdk21" \
