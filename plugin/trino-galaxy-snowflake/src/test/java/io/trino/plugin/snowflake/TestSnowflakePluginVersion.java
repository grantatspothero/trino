...
public class TestSnowflakePluginVersion
{
    /**
     * Snowflake plugin implementation comes from the shared plugin repo,
     * and it's combined with trino-hive and trino-base-jdbc that come
            ...
            throws Exception
    {
        ...
        try (InputStream inputStream = getResource(getClass(), "test-snowflake-plugin-versions.properties").openStream()) {
