    ...
    public void testSessionProperties()
    {
        assertThat(query("SHOW SESSION LIKE '" + CATALOG + ".%'"))
                ...
                .matches("""
                        ...
                        ('objectstore.dynamic_row_filtering_enabled', 'true', 'boolean'),
                        ('objectstore.dynamic_row_filtering_selectivity_threshold', '0.7', 'double'),
                        ('objectstore.dynamic_row_filtering_wait_timeout', '0.00s', 'varchar'),
