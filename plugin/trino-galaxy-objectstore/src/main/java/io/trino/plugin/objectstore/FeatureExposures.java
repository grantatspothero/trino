...
public final class FeatureExposures
{
    ...
    public static Table<TableType, String, FeatureExposure> sessionExposureDecisions()
    {
        return ImmutableTable.<TableType, String, FeatureExposure>builder()
                ...
                .put(HIVE, "delta_lake_catalog_name", EXPOSED)
                ...
                .put(HIVE, "hudi_catalog_name", EXPOSED)
                .put(HIVE, "iceberg_catalog_name", EXPOSED)
                ...
                .put(ICEBERG, "hive_catalog_name", EXPOSED)
                ...
                .put(DELTA, "hive_catalog_name", EXPOSED)
