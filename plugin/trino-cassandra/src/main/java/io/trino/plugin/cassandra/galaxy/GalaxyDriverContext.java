...
public class GalaxyDriverContext
        extends DefaultDriverContext
{
    private final GalaxyCassandraTunnelManager galaxyCassandraTunnelManager;

    public GalaxyDriverContext(DriverConfigLoader configLoader, ProgrammaticArguments programmaticArguments, GalaxyCassandraTunnelManager galaxyCassandraTunnelManager)
    {
    ...
    {
        return new GalaxyDefaultNettyOptions(this, galaxyCassandraTunnelManager);
    }
}
