...
public class GalaxyCommonsHttpClientPoolCache
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GalaxyCommonsHttpClientPoolCache.class);
    ...
    private static SSLContext getSSLContext(ConnectionConfig config)
            throws Exception
    {
...
// End GalaxyCommonsHttpClientPoolCache.java
