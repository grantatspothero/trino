        ...
        implements ConnectorPageSourceProvider
{
            ...
            List<ColumnMapping> columnMappings)
    {
        ...
        for (HiveRecordCursorProvider provider : cursorProviders) {
            List<HiveColumnHandle> desiredColumns = toColumnHandles(regularAndInterimColumnMappings, false, typeManager, coercionContext);
    ...
    public static class ColumnMapping
    {
        ...
        public static List<HiveColumnHandle> toColumnHandles(List<ColumnMapping> regularColumnMappings, boolean doCoercion, TypeManager typeManager, CoercionContext coercionContext)
        {
