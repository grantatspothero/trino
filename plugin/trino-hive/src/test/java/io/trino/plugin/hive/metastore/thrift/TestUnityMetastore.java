...
final class TestUnityMetastore
{
            ...
            throws Exception
    {
        ...
        ThriftMetastoreClient client = ((ThriftMetastoreClientFactory) new HttpThriftMetastoreClientFactory(new SshTunnelConfig(), config, new TestingNodeManager(), OpenTelemetry.noop()))
