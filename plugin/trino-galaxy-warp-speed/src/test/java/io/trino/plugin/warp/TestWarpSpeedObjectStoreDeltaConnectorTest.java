...
import io.trino.plugin.objectstore.TestObjectStoreDeltaConnectorTest;
...
public class TestWarpSpeedObjectStoreDeltaConnectorTest
        extends TestObjectStoreDeltaConnectorTest
{
    @Override
