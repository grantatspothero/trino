...
public class TestWarpSpeedPlugin
{
    ...
    private static final String TESTING_CLUSETER_ID = "w-9999999999";
    ...
    public void testCreateConnector()
    {
        ...
        factory.create(
                        ...
                        ImmutableMap.<String, String>builder()
                                ...
                                .put("OBJECTSTORE__galaxy.cluster-id", TESTING_CLUSETER_ID)
                                ...
                                .put("ICEBERG__galaxy.cluster-id", TESTING_CLUSETER_ID)
