        ...
        implements SchemaEmulation
{
    ...
    @Override
    public void createSchema(IKuduClient client, String schemaName)
    {
    ...
    @Override
    public boolean existsSchema(IKuduClient client, String schemaName)
    {
        if (DEFAULT_SCHEMA.equals(schemaName)) {
            return true;
        }
    ...
    @Override
    public void dropSchema(IKuduClient client, String schemaName)
    {
        if (DEFAULT_SCHEMA.equals(schemaName)) {
    ...
    @Override
    public List<String> listSchemaNames(IKuduClient client)
    {
        try {
    ...
    private KuduTable getSchemasTable(IKuduClient client)
    ...
    private void createAndFillSchemasTable(IKuduClient client)
            throws KuduException
    {
    ...
    private List<String> listSchemaNamesFromTablets(IKuduClient client)
            throws KuduException
    {
