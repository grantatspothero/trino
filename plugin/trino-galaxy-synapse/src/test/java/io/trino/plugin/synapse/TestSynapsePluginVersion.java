...
{
    /**
     * Synapse plugin implementation comes from the shared plugin repo,
     * and it's combined with trino-sqlserver and trino-base-jdbc that come
     ...
     * Galaxy Trino fork have modifications to trino-sqlserver or trino-base-jdbc
            ...
            throws Exception
    {
        ...
        try (InputStream inputStream = getResource(getClass(), "test-synapse-plugin-versions.properties").openStream()) {
