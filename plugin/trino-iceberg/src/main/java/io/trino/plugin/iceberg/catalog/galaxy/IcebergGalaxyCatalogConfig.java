...
public class IcebergGalaxyCatalogConfig
{
    ...
    @Config("iceberg.galaxy.cache-table-metadata")
    public IcebergGalaxyCatalogConfig setCacheTableMetadata(boolean cacheTableMetadata)
    {
